...
const endpoint = "http://" + hostname + ':8095/host'
...
if (request.status >= 200 && request.status < 400) {
  data.forEach(docker_host => {
      ...
      h1.textContent = docker_host.Hostname;
    ...
    //     stat.textContent = `${docker_host.State}`;
    //     // stat.style.backgroundColor = "#F14E44";
    //   } else if (docker_host.State == "running") {
